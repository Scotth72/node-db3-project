...
from category as c
    join product as p on c.id = p.category.Id;
...
select product, ProductionName, orderDetail.Quantity
from orderDetail
...
from [order] as o
    join customer as c on Id = o.CustomerId
    join employess as e on e.Id = o.EmployeeId;